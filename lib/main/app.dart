...
import 'package:kick_stack/core/theme/app_theme.dart';
...
import 'package:kick_stack/main/navigation/app_router.dart';
...
class App extends ConsumerWidget {
  ...
  String getCurrentTitle({
    required ProductFlavor currentFlavor,
...
class AppRouteObserver extends RouteObserver<PageRoute<dynamic>> {
  ...
  void didPop(Route<dynamic> route, Route<dynamic>? previousRoute) {
    ...
    if (previousRoute?.settings.name == RoutePaths.splash) {
      debugPrint("Returned from splash");
      return;
    }
  }
