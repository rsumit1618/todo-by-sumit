...
class RestApiExamplePageViewModel extends BasePageViewModel {
  ...
  void callDashboardSummaryApi() {
    _dashboardRequest.safeAdd(GetDashboardSummaryUseCaseParam());
  }

  void _getDashboardSummaryFromUseCase(
    GetDashboardSummaryUseCaseParam params,
  ) {
    RequestManager<bool>(
      params,
